...
def build_model(image_size,
    ...
    n_predictor_layers = 1 # The number of predictor conv layers in the network CHANGE BACK TO 4
...
#                                                                 anchors7_reshaped])
    ...
    classes_softmax = Activation('softmax', name='classes_softmax')(classes4_reshaped) #CHANGE BACK TO classes_concat

    # Concatenate the class and box coordinate predictions and the anchors to one large predictions tensor
    # Output shape of `predictions`: (batch, n_boxes_total, n_classes + 4 + 8)
    predictions = Concatenate(axis=2, name='predictions')([classes_softmax, boxes4_reshaped, anchors4_reshaped]) #CHANGE BACK TO boxes_concat, anchors_concat
